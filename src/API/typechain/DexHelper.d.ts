...
interface DexHelperInterface extends ethers.utils.Interface {
  functions: {
    ...
    "isBuy(address,address,address,address,address)": FunctionFragment;
    "isSell(address,address,address,address,address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "isBuy",
    values: [string, string, string, string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "isSell",
    values: [string, string, string, string, string]
  ): string;
